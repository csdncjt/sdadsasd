...
namespace ETHotfix
{
    ...
    public class UILoginComponent : UIBaseComponent
    {
        ...
        public void Awake()
        {
            ...
            Log.Debug("Unity Log Awake"); // Unity自带Log
            ...
            Log.Debug("UILoginComponent Awake-add-onClickLogin");
            ...
            GameCache.Instance.strPhoneFirst = PlayerPrefsMgr.mInstance.GetString(PlayerPrefsKeys.KEY_PHONE_FIRST, "61");//前缀  86    没加号
            ...
            LanguageManager.mInstance.mCurLanguage = PlayerPrefsMgr.mInstance.GetInt(PlayerPrefsKeys.KEY_LANGUAGE, 1);
        ...
        private void REQ_LOGIN(REQ_LOGIN req)
        {
            ...
            {
                Log.Debug("mNetOuterComponent is null");
                return;
            }
            try
            {
                Log.Debug("mNetOuterComponent is not null");
                // GlobalData.Instance.LoginHost = "127.0.0.1";
                // GlobalData.Instance.UseDNS = false;
                Log.Debug("LoginHost: " + GlobalData.Instance.LoginHost);
                Log.Debug("UseDNS: " + GlobalData.Instance.UseDNS);
                Log.Debug("LoginPort: " + GlobalData.Instance.LoginPort);
                string[]  mArrAddress = NetHelper.GetAddressIPs(GlobalData.Instance.LoginHost, GlobalData.Instance.UseDNS);
                Log.Debug("mArrAddress: " + mArrAddress[0]);
