...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_RawImage_Binding
    {
        ...
        static StackObject* get_Item_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<UnityEngine.UI.RawImage> instance_of_this_method = (System.Collections.Generic.List<UnityEngine.UI.RawImage>)typeof(System.Collections.Generic.List<UnityEngine.UI.RawImage>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Contains_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.UI.RawImage @item = (UnityEngine.UI.RawImage)typeof(UnityEngine.UI.RawImage).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
